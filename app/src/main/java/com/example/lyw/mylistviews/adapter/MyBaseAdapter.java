package com.example.lyw.mylistviews.adapter;
...
import com.example.lyw.mylistviews.holder.MoreHolder;
...
public abstract class MyBaseAdapter<T> extends BaseAdapter {
	...
	@Override
	public int getCount() {
		return data.size() + 1 ;// 增加加载更多布局数量需要+ 1
	}
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (getItemViewType(position) != TYPE_MORE) {
			...
			//	loadMore(moreHolder);
				Toast.makeText(UIUtils.getContext(),"加载更多",Toast.LENGTH_LONG);
			}
		}
